...
import de.msk.mylivetracker.web.uploader.processor.server.udp.AbstractDataStrInterpreter;
 ...
 * 
 */            
public class UdpInterpreter extends AbstractDataStrInterpreter {
	...
	/* (non-Javadoc)
	 * @see de.msk.mylivetracker.web.uploader.tcpserver.interpreter.AbstractDataStrInterpreter#process(de.msk.mylivetracker.domain.DataReceivedVo, java.lang.String)
	 */
	@Override
	protected void process(DataReceivedVo dataReceived,
