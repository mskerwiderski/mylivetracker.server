...
/**
 * DeviceActionStorePositionMessage.
 * 
 ...
 * 
 */
public class DeviceActionStorePositionMessage extends AbstractDeviceAction {

	/**
	 * constructor.
	 * @param name
	 */
	public DeviceActionStorePositionMessage(String name) {
		super(name);
	}
