 ...
 * 
 */
public class RenewAutoLoginTicketForUser implements IAction {
	...
	public String execute(
		...
		cmd.getUserAutoLogin().setAutoLoginTicketForUser(UserAutoLoginVo.createAutoLoginTicket());
		cmd.setInfoMessage(messageSource.getMessage(
			"autologin.user.ticket.renewed", null, locale));
		return null;
	}
}
